  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold" style={{ color: '#284B63' }}>
            Admin Login
          </h2>
        </div>
        <form className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-md" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium" style={{ color: '#284B63' }}>
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium" style={{ color: '#284B63' }}>
                Password
              </label>
              <div className="relative mt-1">
                <input
                  ...
                  onChange={handleChange}
                  className="appearance-none relative block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:z-10 sm:text-sm"
                />
                <button
                  type="button"
